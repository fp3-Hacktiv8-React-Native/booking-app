    ...
    <ScrollView>
      {route.params.rooms.map((item,index) => (
        <Pressable style={{margin:10,backgroundColor:"white", padding:10}} key={index}>
            ...
            <Text style={{marginTop:3, color:"green", fontSize:156}}>Free cancellation Available</Text>
            ...
            >
                ...
                <Pressable onPress={() => setSelected(item.name)} style={{borderColor:"#007FFF", borderWidth:2, borderRadius:5, padding:10}}>
